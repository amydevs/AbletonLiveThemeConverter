...
impl Into<live10::SkinManager> for live11::Theme {
    fn into(self) -> live10::SkinManager {
        live10::SkinManager {
            ...
            range_edit_field2: self.range_edit_field2.and_then(|v| Some(v.into())),
            ...
            clip1: self.clip1.and_then(|v| Some(v.into())),
            clip2: self.clip2.and_then(|v| Some(v.into())),
            clip3: self.clip3.and_then(|v| Some(v.into())),
            clip4: self.clip4.and_then(|v| Some(v.into())),
            clip5: self.clip5.and_then(|v| Some(v.into())),
            clip6: self.clip6.and_then(|v| Some(v.into())),
            clip7: self.clip7.and_then(|v| Some(v.into())),
            clip8: self.clip8.and_then(|v| Some(v.into())),
            clip9: self.clip9.and_then(|v| Some(v.into())),
            clip10: self.clip10.and_then(|v| Some(v.into())),
            clip11: self.clip11.and_then(|v| Some(v.into())),
            clip12: self.clip12.and_then(|v| Some(v.into())),
            clip13: self.clip13.and_then(|v| Some(v.into())),
            clip14: self.clip14.and_then(|v| Some(v.into())),
            clip15: self.clip15.and_then(|v| Some(v.into())),
            ...
            retro_display_handle2: self.retro_display_handle2.and_then(|v| Some(v.into())),
            ...
            operator3: self.operator3.and_then(|v| Some(v.into())),
            operator4: self.operator4.and_then(|v| Some(v.into())),
            drum_rack_scroller1: self.drum_rack_scroller1.and_then(|v| Some(v.into())),
            drum_rack_scroller2: self.drum_rack_scroller2.and_then(|v| Some(v.into())),
...
impl Into<live11::Theme> for live10::SkinManager {
    fn into(self) -> live11::Theme {
        live11::Theme {
            ...
            clip_contrast_color_adjustment: Some(ValueWrapper { value: 20 }),
            bipolar_poti_triangle: self.bipolar_poti_triangle.and_then(|v| Some(v.into())),
            poti: self.poti.and_then(|v| Some(v.into())),
            deactivated_poti: self.deactivated_poti.and_then(|v| Some(v.into())),
            poti_needle: self.poti_needle.and_then(|v| Some(v.into())),
